...
| 2026-05-29 | tauri-apps/tauri-docs | PR | https://github.com/tauri-apps/tauri-docs/pull/3852 | Fix typo: next.conf.mjs → next.config.mjs in Next.js frontend guide (5 locale files) |
| 2026-05-30 | astral-sh/ruff | PR | https://github.com/astral-sh/ruff/pull/25473 | Fix typo bin/active → bin/activate in tutorial.md venv activation command |
